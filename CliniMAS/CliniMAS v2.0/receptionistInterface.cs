...
namespace CliniMAS_v2._0
{
    public partial class receptionistInterface : Form
    {
        ...
        private void sendToNursesToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void sendToDoctorsToolStripMenuItem_Click_1(object sender, EventArgs e)
        {

        }

        private void sendToAllToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void reserveAppointmentToolStripMenuItem_Click(object sender, EventArgs e)
        {
